...
| Phase 2 - Dedup | ~80 % | URL-Normalisierung, Preflight, Dry-Run, Merge ohne Loeschen, Merge-Undo, Merge-Historie, Conflict Center mit Session-Fortschritt, Sammelentscheidung pro Gruppe, apply_session_defaults, get_restore_session | Pflege-Score; tote Favoriten; Zwei-Wege-Sync-Konflikte (Drift, Loeschungen) |
